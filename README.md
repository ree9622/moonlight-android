...
- 입력 진단과 데스크톱 편의 기능
  ...
  - 원하는 물리 키를 눌러 왼쪽/오른쪽 Windows, Alt, Ctrl, 한영, 한자 키로 학습하고 초기화 가능
...
- Physical keyboard keys can be learned and reset as left/right Windows, Alt, Ctrl, Korean/English, and Hanja keys.
